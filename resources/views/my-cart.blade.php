                        ...
                        <table class="table mb-0">
                            ...
                            @forelse($products as $item)
                                <tr>
                                    ...
                                    <td class="text-right selling-price"
                                        data-selling-price="{{ $item['product_price'] }}">
                                    ...
                                    <td>
                                        ...
                                        <button class="btn btn-danger remove-product" type="button"><i
                            ...
                            @if($products->count())
                                ...
                                <tr>
                                    ...
                                    <td class="border-0">
                                        <a href="{{ route('show.checkout') }}" class="btn btn-primary btn-block">
                                            Proceed to checkout
                                        </a>
                                    </td>
                                </tr>
